    ...
    <div className="inline-block">
      <Link href={href}>
        <div className="group h-[50px] rounded-full relative transition-fade">
          ...
          <p className="h-full rounded-full shadow-2xl flex-center pl-16 pr-6 group-hover:bg-[var(--primary)] group-hover:text-white group-hover:pl-6 group-hover:pr-16 uppercase font-semibold text-lg duration-200 outline outline-[2px] outline-[var(--primary)]">
            {title}
          </p>
        </div>
      </Link>
